...
class SubjectEnrollmentPolicy
{
     ...
     */
    public function restore(User $user, SubjectEnrollment $subjectEnrollment): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, SubjectEnrollment $subjectEnrollment): bool
    {
        //
    }
}
