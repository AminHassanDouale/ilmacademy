...
<div class="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
    ...
    <div class="border-b border-indigo-100 shadow-lg bg-white/80 backdrop-blur-sm">
        <div class="container px-6 py-6 mx-auto">
            <div class="flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-3xl font-bold text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text animate-pulse">
                        {{ $greeting }}
                    </h1>
                ...
                <div class="flex items-center space-x-4">
                    <select wire:model.live="selectedPeriod"
                            class="px-4 py-2 font-medium transition-all duration-300 border border-indigo-200 shadow-sm rounded-xl bg-white/70 text-slate-700 hover:shadow-md focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400">
                        <option value="week">This Week</option>
                        <option value="month">This Month</option>
                        <option value="year">This Year</option>
                    </select>
                    <button class="p-3 text-white transition-all duration-300 transform shadow-lg rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:shadow-xl hover:scale-105">
    ...
    <div class="container px-6 py-8 mx-auto space-y-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="relative p-6 overflow-hidden text-white transition-all duration-500 transform shadow-xl group rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <p class="mt-1 text-sm text-blue-200">Active learners in system</p>
                </div>
            ...
            <div class="relative p-6 overflow-hidden text-white transition-all duration-500 transform shadow-xl group rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <p class="mt-1 text-sm text-emerald-200">Active teaching staff</p>
                </div>
                <div class="absolute w-24 h-24 transition-transform duration-500 rounded-full -bottom-4 -right-4 bg-white/10 group-hover:scale-110"></div>
            </div>
            ...
            <div class="relative p-6 overflow-hidden text-white transition-all duration-500 transform shadow-xl group rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <p class="mt-1 text-sm text-purple-200">Current academic year</p>
                </div>
                <div class="absolute w-24 h-24 transition-transform duration-500 rounded-full -bottom-4 -right-4 bg-white/10 group-hover:scale-110"></div>
            </div>
            ...
            <div class="relative p-6 overflow-hidden text-white transition-all duration-500 transform shadow-xl group rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div class="relative z-10">
                    ...
                    <p class="mt-1 text-sm text-amber-200">Current month earnings</p>
                </div>
                <div class="absolute w-24 h-24 transition-transform duration-500 rounded-full -bottom-4 -right-4 bg-white/10 group-hover:scale-110"></div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <!-- Enrollment Trends -->
            <div class="p-6 transition-all duration-500 border shadow-xl lg:col-span-2 bg-white/70 backdrop-blur-sm rounded-2xl border-white/50 hover:shadow-2xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex space-x-2">
                        <span class="px-3 py-1 text-xs font-medium text-blue-600 bg-blue-100 rounded-full">Enrollments</span>
                        <span class="px-3 py-1 text-xs font-medium rounded-full bg-emerald-100 text-emerald-600">Payments</span>
                    </div>
                </div>
                <div class="h-80">
            ...
            <div class="p-6 transition-all duration-500 border shadow-xl bg-white/70 backdrop-blur-sm rounded-2xl border-white/50 hover:shadow-2xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button class="p-2 transition-all duration-300 rounded-lg bg-gradient-to-r from-slate-100 to-slate-200 hover:from-slate-200 hover:to-slate-300">
            ...
            <div class="p-6 transition-all duration-500 border shadow-xl lg:col-span-2 bg-white/70 backdrop-blur-sm rounded-2xl border-white/50 hover:shadow-2xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('admin.activity-logs.index') }}"
                       class="text-sm font-medium text-indigo-600 transition-colors duration-300 hover:text-indigo-800">
                        View All →
                    </a>
                </div>
                <div class="space-y-4 overflow-y-auto max-h-64">
                    @foreach($recentActivity as $activity)
                    <div class="flex items-start p-4 space-x-4 transition-all duration-300 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100 hover:from-slate-100 hover:to-slate-200">
                        <div class="flex items-center justify-center w-10 h-10 text-sm font-bold text-white rounded-full bg-gradient-to-r from-indigo-500 to-purple-600">
            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-8">
                <a href="{{ route('admin.users.create') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Add User</span>
                </a>
                ...
                <a href="{{ route('admin.enrollments.create') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100 hover:from-emerald-100 hover:to-emerald-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">New Enrollment</span>
                </a>
                ...
                <a href="{{ route('admin.invoices.create') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Create Invoice</span>
                </a>
                ...
                <a href="{{ route('admin.reports.finances') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-amber-50 to-amber-100 hover:from-amber-100 hover:to-amber-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Financial Report</span>
                </a>
                ...
                <a href="{{ route('admin.curricula.index') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-rose-50 to-rose-100 hover:from-rose-100 hover:to-rose-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Curricula</span>
                </a>
                ...
                <a href="{{ route('admin.teachers.index') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-indigo-50 to-indigo-100 hover:from-indigo-100 hover:to-indigo-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Teachers</span>
                </a>
                ...
                <a href="{{ route('admin.timetable.index') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-teal-50 to-teal-100 hover:from-teal-100 hover:to-teal-200 hover:scale-105">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Timetable</span>
                </a>

                <a href="{{ route('admin.settings.index') }}"
                   class="flex flex-col items-center p-4 transition-all duration-300 transform group rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 hover:from-slate-100 hover:to-slate-200 hover:scale-105">
                    <div class="flex items-center justify-center w-12 h-12 mb-3 text-white transition-colors duration-300 rounded-xl bg-slate-500 group-hover:bg-slate-600">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm font-medium transition-colors duration-300 text-slate-700 group-hover:text-slate-900">Settings</span>
                </a>
            </div>
        </div>
        ...
        <div class="p-6 border-l-4 border-red-400 shadow-lg bg-gradient-to-r from-red-50 to-red-100 rounded-xl">
                ...
                <div class="flex-1 ml-3">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('admin.invoices.index') }}?status=overdue"
                           class="inline-flex items-center px-4 py-2 font-medium text-white transition-colors duration-300 bg-red-600 rounded-lg hover:bg-red-700">
