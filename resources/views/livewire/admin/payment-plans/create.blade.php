...
new #[Title('Create Payment Plan')] class extends Component {
    ...
    #[Rule('required|in:Monthly,Quarterly,Annual,One-Time')]
    public string $type = '';
    ...
    // Predefined payment plan types (matching your database enum)
    ...
    public function save(): void
    {
        ...
        try {
            ...
            ActivityLog::log(
                Auth::id(),
                'create',
                "Created payment plan: {$this->type} (\${$this->amount}) for {$curriculumName}",
                PaymentPlan::class,
                $paymentPlan->id,
                [
                    'payment_plan_type' => $this->type,
                    'payment_plan_amount' => $this->amount,
                    'due_day' => $this->due_day,
                    'curriculum_id' => $this->curriculum_id,
            ...
            $this->success("Payment plan '{$this->type}' has been created successfully.");
...
<div>
    ...
    <x-card class="max-w-2xl mx-auto">
        ...
        <x-slot:actions>
            ...
            <x-button label="Create Payment Plan" icon="o-plus" wire:click="save" class="btn-primary" spinner="save" />
        </x-slot:actions>
    </x-card>
</div>
